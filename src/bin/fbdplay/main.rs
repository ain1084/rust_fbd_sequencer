...
fn main() {
    ...
    let mut psg: Box<dyn PsgTrait> = match cli.psg_crate {
        PsgCrate::psg => Box::new(psg_wrapper_psg::PsgWrapper::new(clock_rate_hz, cli.sample_rate)),
        PsgCrate::psg_lite => Box::new(psg_wrapper_psg_lite::PsgWrapper::new(clock_rate_hz, cli.sample_rate)),
    };
